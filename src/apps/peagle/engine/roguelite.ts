...
export const CLASSES: Record<ClassId, PlayerClass> = {
  canonnier: {
    id: "canonnier",
    name: "Aigle",
    desc: "+2 œufs par niveau. Pas de bombes — trop fier pour ça.",
    startBalls: 12,
    startRelics: [],
    ...
    ballRadiusMult: 1,
    aimStepsMult: 1,
    flavorText: "Qui a besoin de précision quand on domine tout depuis les hauteurs ?",
  },
  alchimiste: {
    id: "alchimiste",
    name: "Hibou",
    desc: "2 reliques aléatoires au départ. Les hiboux voient tout dans le noir.",
    startBalls: 9,
    startRelics: [],
    greenPowerupPool: ["multiball", "spooky", "extraball", "magnet"],
    noBombs: false,
    ballRadiusMult: 1,
    aimStepsMult: 1,
    flavorText: "Le hibou ne dort jamais. Il attend. Il sait.",
  },
  sniper: {
    id: "sniper",
    name: "Pingouin",
    desc: "Ligne de visée ×2. Petits œufs (−30%). Précision de nageur professionnel.",
    startBalls: 10,
    ...
    ballRadiusMult: 0.7,
    aimStepsMult: 2,
    flavorText: "Le pingouin n'a jamais raté une cible. On ne lui pose pas de questions.",
  },
};
