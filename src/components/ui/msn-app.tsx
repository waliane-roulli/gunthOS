  ...
  return (
    ...
    >
      ...
      >
        {messages.length === 0 && (
          <div
            className="text-center text-xs tracking-wider mt-8 leading-relaxed"
            style={{ color: "#888", fontFamily: "var(--t-font-display)" }}
          >
          ...
          return (
            <div key={msg.id} className={`flex flex-col ${isMe ? "items-end" : "items-start"}`}>
              <div className="flex items-end gap-1">
                ...
                >
                  {!isMe && (
                    <div style={{ fontWeight: "bold", fontSize: 11, marginBottom: 2, color: "#0055aa" }}>
                      {displayName}
                    </div>
                  )}
                  {text}
...
export function MsnApp() {
  ...
  const filtered = contacts.filter((c) => {
    ...
    const name = (c.displayUsername || c.username || c.name).toLowerCase();
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div style={{ fontFamily: "Arial, sans-serif", fontWeight: "bold", fontSize: 14, letterSpacing: 1 }}>
              GunthMessenger™
            </div>
            <div style={{ fontSize: 10, opacity: 0.85, fontFamily: "Arial, sans-serif" }}>
          ...
          <div style={{ flexShrink: 0 }}>
            {myAvatar ? (
              <img
                src={myAvatar}
                alt="moi"
                style={{ width: 36, height: 36, objectFit: "cover", border: "2px solid rgba(255,255,255,0.5)" }}
              />
            ) : (
              <div style={{ fontSize: 28, lineHeight: 1 }}>
                {user ? getDefaultAvatar(user.id) : "👤"}
              </div>
            )}
          </div>
          <div className="flex-1 min-w-0">
            <div style={{ fontFamily: "Arial, sans-serif", fontWeight: "bold", fontSize: 12, color: "white" }}>
              {myDisplayName}
            </div>
            <div style={{ fontSize: 10, color: "rgba(255,255,255,0.8)", fontFamily: "Arial, sans-serif", fontStyle: "italic" }}>
              {myAwayMsg}
            </div>
          </div>
          {/* Status selector */}
      ...
      <div className="flex-1 overflow-y-auto">
        {!user ? (
          ...
          >
            ...
            <div className="text-xs tracking-wider" style={{ color: "var(--t-text-subtle)" }}>
              Identifiez-vous pour accéder à GunthMessenger™
            </div>
            <button
          ...
          <div className="p-4 text-center" style={{ color: "var(--t-text-muted)" }}>
            ...
            <div className="text-xs mt-1" style={{ color: "var(--t-text-subtle)" }}>
              Vous êtes seul(e) sur GunthOS.<br />C'est très triste.
            </div>
          </div>
        ) : (
          <>
      ...
      {/* Footer MSN style */}
      <div
        className="shrink-0 px-3 py-1 flex items-center justify-between"
        style={{
  ...
  return (
    <div key={label}>
      ...
      >
        <span>▸</span>
        <span>{label}</span>
        <span style={{ opacity: 0.6 }}>({contacts.length})</span>
      </div>
      ...
      {contacts.map((contact) => {
        ...
        return (
          <div
            ...
            style={{
              borderBottom: "1px solid var(--t-border-dark)",
              background: isOpen ? "var(--t-card-hover)" : "transparent",
          ...
          >
            ...
            <div className="flex gap-1 opacity-0 group-hover:opacity-100" style={{ transition: "opacity 0.1s" }}>
              <button
                onClick={(e) => { e.stopPropagation(); toggleChat(contact); }}
              ...
              <button
                onClick={(e) => { e.stopPropagation(); openProfile(contact.username); }}
